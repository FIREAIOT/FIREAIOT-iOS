...
class SegmentCell: UICollectionViewCell {
    ...
    var cellSelected = false {
        didSet {
            layer.borderWidth = cellSelected ? 2 : 0
    ...
    fileprivate var options = SegmentOptions()
    fileprivate var style = SegmentStyle.imageOverLabel
    ...
    func configure(content: SegmentItem, style: SegmentStyle, options: SegmentOptions, isLastCell: Bool) {
    ...
    fileprivate func setupContent(content: SegmentItem) {
    ...
    fileprivate func setupConstraint(indicatorOptions: SegmentIndicatorOptions) {
